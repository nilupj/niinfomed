...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 29: (a, b, c) => {
      "use strict";
      ...
      let e = c(117), f = { url: (a2) => a2.url, header: (a2, b2) => a2.headers.get(b2) };
      ...
      "use strict";
      let d;
      c.r(b), c.d(b, { default: () => bw });
      var e, f = {};
      async function g() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(f), c.d(f, { config: () => bs, middleware: () => br });
      let h = null;
      async function i() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let aw = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: ax, propagation: ay, trace: az, SpanStatusCode: aA, SpanKind: aB, ROOT_CONTEXT: aC } = d = c(904);
      ...
      class a2 {
        ...
        after(a10) {
          if (av(a10)) this.waitUntil || a3(), this.waitUntil(a10.catch((a11) => this.reportTaskError("promise", a11)));
      ...
      async function a8(a10, b2, c2) {
        ...
        return { tags: d2, expirationsByCacheKind: function(a11) {
          ...
          if (c3) for (let [d3, e3] of c3) "getExpiration" in e3 && b3.set(d3, a4(async () => e3.getExpiration(...a11)));
          return b3;
        }(d2) };
      }
      class a9 extends N {
      ...
      let ba = { keys: (a10) => Array.from(a10.keys()), get: (a10, b2) => a10.get(b2) ?? void 0 }, bb = (a10, b2) => aK().withPropagatedContext(a10.headers, b2, ba), bc = false;
      async function bd(a10) {
        var b2;
        let d2, e2;
        if (!bc && (bc = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
          let { interceptTestApis: a11, wrapRequestHandler: b3 } = c(29);
          a11(), bb = b3(bb);
        }
        await l();
        ...
        let n2 = g2.searchParams.get(W), o2 = new a9({ page: a10.page, input: function(a11) {
        ...
        if ((d2 = await bb(o2, () => {
          if ("/middleware" === a10.page || "/src/middleware" === a10.page) {
            let b3 = q2.waitUntil.bind(q2), c2 = new a5();
            return aK().trace(as.execute, { spanName: `middleware ${o2.method} ${o2.nextUrl.pathname}`, attributes: { "http.target": o2.nextUrl.pathname, "http.method": o2.method } }, async () => {
              try {
                ...
                let l2 = a6(), m3 = await a8("/", o2.nextUrl, null), n3 = (j3 = o2.nextUrl, k3 = (a11) => {
                  e2 = a11;
                  ...
                  let g4 = !b4.shouldWaitOnAllReady && !b4.supportsDynamicResponse && !b4.isDraftMode && !b4.isPossibleServerAction, h3 = b4.dev ?? false, i4 = h3 || g4 && (!!process.env.NEXT_DEBUG_BUILD || "1" === process.env.NEXT_SSG_FETCH_METRICS), j4 = { isStaticGeneration: g4, page: a11, route: (f4 = a11.split("/").reduce((a12, b5, c4, d5) => b5 ? "(" === b5[0] && b5.endsWith(")") || "@" === b5[0] || ("page" === b5 || "route" === b5) && c4 === d5.length - 1 ? a12 : a12 + "/" + b5 : a12, "")).startsWith("/") ? f4 : "/" + f4, incrementalCache: b4.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: b4.cacheLifeProfiles, isRevalidate: b4.isRevalidate, isBuildTimePrerendering: b4.nextExport, hasReadableErrorStacks: b4.hasReadableErrorStacks, fetchCache: b4.fetchCache, isOnDemandRevalidate: b4.isOnDemandRevalidate, isDraftMode: b4.isDraftMode, isPrefetchRequest: c3, buildId: d4, reactLoadableManifest: (null == b4 ? void 0 : b4.reactLoadableManifest) || {}, assetPrefix: (null == b4 ? void 0 : b4.assetPrefix) || "", afterContext: function(a12) {
                    ...
                    return new a2({ waitUntil: b5, onClose: c4, onTaskError: d5 });
                    ...
                    if (b5) for (let [c4, d5] of b5) "refreshTags" in d5 && a12.set(c4, a4(async () => d5.refreshTags()));
                    return a12;
                  }(), runInCleanSnapshot: _ ? _.snapshot() : function(a12, ...b5) {
                    return a12(...b5);
      ...
      c(500), "undefined" == typeof URLPattern || URLPattern;
      var be = c(923);
      if (/* @__PURE__ */ new WeakMap(), be.unstable_postpone, false === function(a10) {
      ...
      let { env: bf, stdout: bg } = (null == (e = globalThis) ? void 0 : e.process) ?? {}, bh = bf && !bf.NO_COLOR && (bf.FORCE_COLOR || (null == bg ? void 0 : bg.isTTY) && !bf.CI && "dumb" !== bf.TERM), bi = (a10, b2, c2, d2) => {
        let e2 = a10.substring(0, d2) + c2, f2 = a10.substring(d2 + b2.length), g2 = f2.indexOf(b2);
        return ~g2 ? e2 + bi(f2, b2, c2, g2) : e2 + f2;
      }, bj = (a10, b2, c2 = a10) => bh ? (d2) => {
        let e2 = "" + d2, f2 = e2.indexOf(b2, a10.length);
        return ~f2 ? a10 + bi(e2, b2, c2, f2) + b2 : a10 + e2 + b2;
      } : String, bk = bj("\x1B[1m", "\x1B[22m", "\x1B[22m\x1B[1m");
      bj("\x1B[2m", "\x1B[22m", "\x1B[22m\x1B[2m"), bj("\x1B[3m", "\x1B[23m"), bj("\x1B[4m", "\x1B[24m"), bj("\x1B[7m", "\x1B[27m"), bj("\x1B[8m", "\x1B[28m"), bj("\x1B[9m", "\x1B[29m"), bj("\x1B[30m", "\x1B[39m");
      let bl = bj("\x1B[31m", "\x1B[39m"), bm = bj("\x1B[32m", "\x1B[39m"), bn = bj("\x1B[33m", "\x1B[39m");
      bj("\x1B[34m", "\x1B[39m");
      let bo = bj("\x1B[35m", "\x1B[39m");
      bj("\x1B[38;2;173;127;168m", "\x1B[39m"), bj("\x1B[36m", "\x1B[39m");
      let bp = bj("\x1B[37m", "\x1B[39m");
      bj("\x1B[90m", "\x1B[39m"), bj("\x1B[40m", "\x1B[49m"), bj("\x1B[41m", "\x1B[49m"), bj("\x1B[42m", "\x1B[49m"), bj("\x1B[43m", "\x1B[49m"), bj("\x1B[44m", "\x1B[49m"), bj("\x1B[45m", "\x1B[49m"), bj("\x1B[46m", "\x1B[49m"), bj("\x1B[47m", "\x1B[49m"), bp(bk("\u25CB")), bl(bk("\u2A2F")), bn(bk("\u26A0")), bp(bk(" ")), bm(bk("\u2713")), bo(bk("\xBB")), new aU(1e4, (a10) => a10.length), /* @__PURE__ */ new WeakMap();
      let bq = { GB: "/uk", CN: "/cn", FR: "/fr", DE: "/de", ES: "/es" };
      async function br(a10) {
        let { pathname: b2 } = a10.nextUrl;
        if (b2.startsWith("/_next") || b2.startsWith("/api") || b2.includes(".")) return S.next();
        let c2 = a10.headers.get("user-agent") || "", d2 = /bot|crawler|spider|google|bing|yandex|baidu/i.test(c2);
        if (b2.startsWith("/articles/")) {
          let c3 = b2.replace("/articles/", "").replace(/\/$/, "");
          try {
            let b3 = "http://161.118.167.107";
            if (!(await fetch(`${b3}/api/articles/${c3}/`, { method: "HEAD" })).ok) {
              if ((await fetch(`${b3}/api/news/${c3}/`, { method: "HEAD" })).ok) return S.redirect(new URL(`/news/${c3}`, a10.url), 302);
              if ((await fetch(`${b3}/api/wellness/topics/${c3}/`, { method: "HEAD" })).ok) return S.redirect(new URL(`/wellness/${c3}`, a10.url), 302);
              if ((await fetch(`${b3}/api/yoga/topics/${c3}/`, { method: "HEAD" })).ok) return S.redirect(new URL(`/yoga-exercise/${c3}`, a10.url), 302);
              try {
                if ((await fetch(`${b3}/api/videos/${c3}/`)).ok) return S.redirect(new URL(`/videos/${c3}`, a10.url), 302);
              } catch (a11) {
              }
            }
          } catch (a11) {
        ...
        if (/^\/(uk|cn|fr|de|es)(\/|$)/.test(b2) || d2) return S.next();
        let e2 = a10.headers.get("cf-ipcountry") || a10.geo?.country || null;
        if (!e2) return S.next();
        let f2 = bq[e2];
        if (!f2) return S.next();
        let g2 = a10.nextUrl.clone();
        return g2.pathname = `${f2}${b2}`, S.redirect(g2, 302);
      }
      let bs = { matcher: ["/articles/:path*", "/((?!_next|api|favicon.ico).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bt = { ...f }, bu = bt.middleware || bt.default, bv = "/middleware";
      if ("function" != typeof bu) throw Object.defineProperty(Error(`The Middleware "${bv}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function bw(a10) {
        return bd({ ...a10, page: bv, handler: async (...a11) => {
          try {
            return await bu(...a11);
          } catch (e2) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/articles(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|api|favicon.ico).*))(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.js", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [{ "protocol": "http", "hostname": "161.118.167.107", "pathname": "/media/**" }, { "protocol": "http", "hostname": "161.118.167.107", "pathname": "/api/**" }, { "protocol": "https", "hostname": "api.niinfomed.com", "pathname": "/media/**" }, { "protocol": "https", "hostname": "niinfomed.com", "pathname": "/media/**" }, { "protocol": "http", "hostname": "localhost", "port": "8001", "pathname": "/media/**" }, { "protocol": "http", "hostname": "192.168.31.238", "port": "8001", "pathname": "/media/**" }, { "protocol": "http", "hostname": "127.0.0.1", "port": "8001", "pathname": "/media/**" }, { "protocol": "https", "hostname": "images.unsplash.com", "pathname": "/**" }, { "protocol": "https", "hostname": "*.unsplash.com", "pathname": "/**" }], "unoptimized": true }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": true, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": { "removeConsole": true }, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/home/nirvay37/mydata/Downloads/niinfomed/frontend", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 11, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.js", "swcMinify": true, "turbopack": { "root": "/home/nirvay37/mydata/Downloads/niinfomed/frontend" }, "_originalRewrites": { "beforeFiles": [], "afterFiles": [{ "source": "/cms-api/:path*", "destination": "http://161.118.167.107/api/:path*" }, { "source": "/api/:path*", "destination": "http://161.118.167.107/api/:path*" }, { "source": "/media/:path*", "destination": "http://161.118.167.107/media/:path*" }, { "source": "/cms-media/:path*", "destination": "http://161.118.167.107/media/:path*" }, { "source": "/documents/:path*", "destination": "http://161.118.167.107/documents/:path*" }, { "source": "/api/v2/:path*", "destination": "http://161.118.167.107/api/v2/:path*" }], "fallback": [] } };
var BuildId = "0ns8JbIlt2Ny--4ccSFgl";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [{ "source": "/cms-api/:path*", "destination": "http://161.118.167.107/api/:path*", "regex": "^/cms-api(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/api/:path*", "destination": "http://161.118.167.107/api/:path*", "regex": "^/api(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/media/:path*", "destination": "http://161.118.167.107/media/:path*", "regex": "^/media(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/cms-media/:path*", "destination": "http://161.118.167.107/media/:path*", "regex": "^/cms-media(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/documents/:path*", "destination": "http://161.118.167.107/documents/:path*", "regex": "^/documents(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/api/v2/:path*", "destination": "http://161.118.167.107/api/v2/:path*", "regex": "^/api/v2(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/404", "regex": "^/404(?:/)?$", "routeKeys": {}, "namedRegex": "^/404(?:/)?$" }, { "page": "/about", "regex": "^/about(?:/)?$", "routeKeys": {}, "namedRegex": "^/about(?:/)?$" }, { "page": "/about-ads", "regex": "^/about\\-ads(?:/)?$", "routeKeys": {}, "namedRegex": "^/about\\-ads(?:/)?$" }, { "page": "/account", "regex": "^/account(?:/)?$", "routeKeys": {}, "namedRegex": "^/account(?:/)?$" }, { "page": "/account/saved", "regex": "^/account/saved(?:/)?$", "routeKeys": {}, "namedRegex": "^/account/saved(?:/)?$" }, { "page": "/ayurveda", "regex": "^/ayurveda(?:/)?$", "routeKeys": {}, "namedRegex": "^/ayurveda(?:/)?$" }, { "page": "/cms-status", "regex": "^/cms\\-status(?:/)?$", "routeKeys": {}, "namedRegex": "^/cms\\-status(?:/)?$" }, { "page": "/conditions", "regex": "^/conditions(?:/)?$", "routeKeys": {}, "namedRegex": "^/conditions(?:/)?$" }, { "page": "/contact", "regex": "^/contact(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact(?:/)?$" }, { "page": "/content-test", "regex": "^/content\\-test(?:/)?$", "routeKeys": {}, "namedRegex": "^/content\\-test(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/disclaimer", "regex": "^/disclaimer(?:/)?$", "routeKeys": {}, "namedRegex": "^/disclaimer(?:/)?$" }, { "page": "/doctors", "regex": "^/doctors(?:/)?$", "routeKeys": {}, "namedRegex": "^/doctors(?:/)?$" }, { "page": "/drugs", "regex": "^/drugs(?:/)?$", "routeKeys": {}, "namedRegex": "^/drugs(?:/)?$" }, { "page": "/drugs-supplements", "regex": "^/drugs\\-supplements(?:/)?$", "routeKeys": {}, "namedRegex": "^/drugs\\-supplements(?:/)?$" }, { "page": "/editorial-board", "regex": "^/editorial\\-board(?:/)?$", "routeKeys": {}, "namedRegex": "^/editorial\\-board(?:/)?$" }, { "page": "/forgot-password", "regex": "^/forgot\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/forgot\\-password(?:/)?$" }, { "page": "/health-news", "regex": "^/health\\-news(?:/)?$", "routeKeys": {}, "namedRegex": "^/health\\-news(?:/)?$" }, { "page": "/homeopathy", "regex": "^/homeopathy(?:/)?$", "routeKeys": {}, "namedRegex": "^/homeopathy(?:/)?$" }, { "page": "/news", "regex": "^/news(?:/)?$", "routeKeys": {}, "namedRegex": "^/news(?:/)?$" }, { "page": "/privacy", "regex": "^/privacy(?:/)?$", "routeKeys": {}, "namedRegex": "^/privacy(?:/)?$" }, { "page": "/quizzes", "regex": "^/quizzes(?:/)?$", "routeKeys": {}, "namedRegex": "^/quizzes(?:/)?$" }, { "page": "/remedies", "regex": "^/remedies(?:/)?$", "routeKeys": {}, "namedRegex": "^/remedies(?:/)?$" }, { "page": "/remedies/slug", "regex": "^/remedies/slug(?:/)?$", "routeKeys": {}, "namedRegex": "^/remedies/slug(?:/)?$" }, { "page": "/search", "regex": "^/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/search(?:/)?$" }, { "page": "/sentry-example-page", "regex": "^/sentry\\-example\\-page(?:/)?$", "routeKeys": {}, "namedRegex": "^/sentry\\-example\\-page(?:/)?$" }, { "page": "/SharaButton", "regex": "^/SharaButton(?:/)?$", "routeKeys": {}, "namedRegex": "^/SharaButton(?:/)?$" }, { "page": "/sitemap-images.xml", "regex": "^/sitemap\\-images\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\-images\\.xml(?:/)?$" }, { "page": "/sitemap.xml", "regex": "^/sitemap\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\.xml(?:/)?$" }, { "page": "/symptom-checker", "regex": "^/symptom\\-checker(?:/)?$", "routeKeys": {}, "namedRegex": "^/symptom\\-checker(?:/)?$" }, { "page": "/terms", "regex": "^/terms(?:/)?$", "routeKeys": {}, "namedRegex": "^/terms(?:/)?$" }, { "page": "/tools", "regex": "^/tools(?:/)?$", "routeKeys": {}, "namedRegex": "^/tools(?:/)?$" }, { "page": "/trending", "regex": "^/trending(?:/)?$", "routeKeys": {}, "namedRegex": "^/trending(?:/)?$" }, { "page": "/videos", "regex": "^/videos(?:/)?$", "routeKeys": {}, "namedRegex": "^/videos(?:/)?$" }, { "page": "/well-being", "regex": "^/well\\-being(?:/)?$", "routeKeys": {}, "namedRegex": "^/well\\-being(?:/)?$" }, { "page": "/wellness", "regex": "^/wellness(?:/)?$", "routeKeys": {}, "namedRegex": "^/wellness(?:/)?$" }, { "page": "/yoga-exercise", "regex": "^/yoga\\-exercise(?:/)?$", "routeKeys": {}, "namedRegex": "^/yoga\\-exercise(?:/)?$" }], "dynamic": [{ "page": "/api/articles/[slug]", "regex": "^/api/articles/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/articles/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/articles/[slug]/related", "regex": "^/api/articles/([^/]+?)/related(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/articles/(?<nxtPslug>[^/]+?)/related(?:/)?$" }, { "page": "/api/conditions/[slug]", "regex": "^/api/conditions/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/conditions/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/drugs/[slug]", "regex": "^/api/drugs/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/drugs/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/news/[slug]", "regex": "^/api/news/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/news/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/articles/[slug]", "regex": "^/articles/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/articles/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/authors/[slug]", "regex": "^/authors/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/authors/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/ayurveda/[slug]", "regex": "^/ayurveda/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/ayurveda/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/conditions/[slug]", "regex": "^/conditions/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/conditions/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/doctors/[slug]", "regex": "^/doctors/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/doctors/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/drugs/[slug]", "regex": "^/drugs/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/drugs/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/homeopathy/[slug]", "regex": "^/homeopathy/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/homeopathy/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/news/[slug]", "regex": "^/news/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/news/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/quizzes/[slug]", "regex": "^/quizzes/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/quizzes/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/reviewers/[slug]", "regex": "^/reviewers/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/reviewers/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/trending/[slug]", "regex": "^/trending/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/trending/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/videos/[slug]", "regex": "^/videos/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/videos/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/wellness/[slug]", "regex": "^/wellness/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/wellness/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/yoga-exercise/[slug]", "regex": "^/yoga\\-exercise/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/yoga\\-exercise/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [{ "page": "/", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/index\\.json$" }, { "page": "/dashboard", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/dashboard\\.json$" }, { "page": "/doctors", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/doctors\\.json$" }, { "page": "/drugs", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/drugs\\.json$" }, { "page": "/drugs-supplements", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/drugs-supplements\\.json$" }, { "page": "/editorial-board", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/editorial-board\\.json$" }, { "page": "/homeopathy", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/homeopathy\\.json$" }, { "page": "/sitemap-images.xml", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/sitemap-images.xml\\.json$" }, { "page": "/sitemap.xml", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/sitemap.xml\\.json$" }, { "page": "/well-being", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/well-being\\.json$" }], "dynamic": [{ "page": "/articles/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/articles/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/articles/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/ayurveda/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/ayurveda/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/ayurveda/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/conditions/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/conditions/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/conditions/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/doctors/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/doctors/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/doctors/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/drugs/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/drugs/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/drugs/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/homeopathy/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/homeopathy/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/homeopathy/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/news/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/news/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/news/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/videos/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/videos/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/videos/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/wellness/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/wellness/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/wellness/(?<nxtPslug>[^/]+?)\\.json$" }, { "page": "/yoga-exercise/[slug]", "routeKeys": { "nxtPslug": "nxtPslug" }, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/yoga\\-exercise/([^/]+?)\\.json$", "namedDataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/yoga\\-exercise/(?<nxtPslug>[^/]+?)\\.json$" }] } }, "locales": [] };
var ConfigHeaders = [{ "source": "/:path*", "headers": [{ "key": "X-Content-Type-Options", "value": "nosniff" }, { "key": "X-Frame-Options", "value": "DENY" }, { "key": "X-XSS-Protection", "value": "1; mode=block" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/cms-api/:path*", "headers": [{ "key": "Access-Control-Allow-Origin", "value": "*" }, { "key": "Access-Control-Allow-Methods", "value": "GET, POST, PUT, DELETE, OPTIONS" }, { "key": "Access-Control-Allow-Headers", "value": "Content-Type, Authorization" }], "regex": "^/cms-api(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }];
var PrerenderManifest = { "version": 4, "routes": { "/doctors": { "initialRevalidateSeconds": false, "srcRoute": null, "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/doctors.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/drugs": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": null, "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/drugs.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/homeopathy": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": null, "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/homeopathy.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/well-being": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": null, "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/well-being.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/drugs-supplements": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": null, "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/drugs-supplements.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": null, "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/index.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/news/hgjh": { "initialRevalidateSeconds": false, "srcRoute": "/news/[slug]", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/news/hgjh.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/videos/jbj": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": "/videos/[slug]", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/videos/jbj.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/ayurveda/ayurved": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": "/ayurveda/[slug]", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/ayurveda/ayurved.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/homeopathy/hgfchj": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": "/homeopathy/[slug]", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/homeopathy/hgfchj.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/wellness/jhckjxksk": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": "/wellness/[slug]", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/wellness/jhckjxksk.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/yoga-exercise/kaplabhati": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": "/yoga-exercise/[slug]", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/yoga-exercise/kaplabhati.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/drugs/hdchgm": { "initialRevalidateSeconds": 3600, "initialExpireSeconds": 31536e3, "srcRoute": "/drugs/[slug]", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/drugs/hdchgm.json", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": { "/doctors/[slug]": { "routeRegex": "^/doctors/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/doctors/[slug].json", "fallback": false, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/doctors/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/articles/[slug]": { "routeRegex": "^/articles/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/articles/[slug].json", "fallback": "/articles/[slug].html", "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/articles/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/conditions/[slug]": { "routeRegex": "^/conditions/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/conditions/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/conditions/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/news/[slug]": { "routeRegex": "^/news/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/news/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/news/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/videos/[slug]": { "routeRegex": "^/videos/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/videos/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/videos/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/ayurveda/[slug]": { "routeRegex": "^/ayurveda/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/ayurveda/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/ayurveda/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/homeopathy/[slug]": { "routeRegex": "^/homeopathy/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/homeopathy/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/homeopathy/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/wellness/[slug]": { "routeRegex": "^/wellness/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/wellness/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/wellness/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/yoga-exercise/[slug]": { "routeRegex": "^/yoga\\-exercise/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/yoga-exercise/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/yoga\\-exercise/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/drugs/[slug]": { "routeRegex": "^/drugs/([^/]+?)(?:/)?$", "dataRoute": "/_next/data/0ns8JbIlt2Ny--4ccSFgl/drugs/[slug].json", "fallback": null, "dataRouteRegex": "^/_next/data/0ns8JbIlt2Ny\\-\\-4ccSFgl/drugs/([^/]+?)\\.json$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "notFoundRoutes": ["/doctors", "/news/hgjh"], "preview": { "previewModeId": "13f480ae60bcc66330063bf18fa099d8", "previewModeSigningKey": "99f6cf79188fca499d283001f311be386bad6ca2056a222a5a9d637f148bb2d1", "previewModeEncryptionKey": "d244f0b9c8be1946247c819901d2d7e4f87cb28856c7401fdadbb807e5749a8b" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/articles(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/articles/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|api|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next|api|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "0ns8JbIlt2Ny--4ccSFgl", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "ngZ0JCtnWi/qoE0KKwzr/bg1EyOFRFQMWMkOIUXuReQ=", "__NEXT_PREVIEW_MODE_ID": "13f480ae60bcc66330063bf18fa099d8", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "99f6cf79188fca499d283001f311be386bad6ca2056a222a5a9d637f148bb2d1", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "d244f0b9c8be1946247c819901d2d7e4f87cb28856c7401fdadbb807e5749a8b" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = {};
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/articles/[slug]": {}, "/api/articles/[slug]/related": {}, "/api/articles/health-topics": {}, "/api/articles/paths": {}, "/api/articles/top-stories": {}, "/api/conditions/[slug]": {}, "/api/conditions": {}, "/api/conditions/paths": {}, "/api/news/[slug]": {}, "/api/news/latest": {}, "/api/news/paths": {}, "/api/search": {}, "/api/videos": {}, "/api/wellness/topics": {} } };
var PagesManifest = { "/_app": "pages/_app.js", "/_error": "pages/_error.js", "/_document": "pages/_document.js", "/SharaButton": "pages/SharaButton.html", "/404": "pages/404.html", "/about-ads": "pages/about-ads.html", "/about": "pages/about.html", "/account": "pages/account.html", "/account/saved": "pages/account/saved.html", "/api/drugs/[slug]": "pages/api/drugs/[slug].js", "/api/drugs": "pages/api/drugs.js", "/api/drugs/paths": "pages/api/drugs/paths.js", "/api/sentry-example-api": "pages/api/sentry-example-api.js", "/authors/[slug]": "pages/authors/[slug].html", "/ayurveda": "pages/ayurveda.html", "/cms-status": "pages/cms-status.html", "/content-test": "pages/content-test.html", "/contact": "pages/contact.html", "/disclaimer": "pages/disclaimer.html", "/forgot-password": "pages/forgot-password.html", "/health-news": "pages/health-news.html", "/news": "pages/news.html", "/quizzes/[slug]": "pages/quizzes/[slug].html", "/privacy": "pages/privacy.html", "/quizzes": "pages/quizzes.html", "/remedies": "pages/remedies.html", "/remedies/slug": "pages/remedies/slug.html", "/reviewers/[slug]": "pages/reviewers/[slug].html", "/sentry-example-page": "pages/sentry-example-page.html", "/search": "pages/search.html", "/symptom-checker": "pages/symptom-checker.html", "/tools": "pages/tools.html", "/terms": "pages/terms.html", "/trending/[slug]": "pages/trending/[slug].html", "/trending": "pages/trending.html", "/videos": "pages/videos.html", "/wellness": "pages/wellness.html", "/yoga-exercise": "pages/yoga-exercise.html", "/api/articles/[slug]/related": "pages/api/articles/[slug]/related.js", "/api/articles/health-topics": "pages/api/articles/health-topics.js", "/api/articles/paths": "pages/api/articles/paths.js", "/api/articles/top-stories": "pages/api/articles/top-stories.js", "/api/conditions": "pages/api/conditions.js", "/api/conditions/paths": "pages/api/conditions/paths.js", "/api/articles/[slug]": "pages/api/articles/[slug].js", "/api/conditions/[slug]": "pages/api/conditions/[slug].js", "/api/news/[slug]": "pages/api/news/[slug].js", "/api/news/paths": "pages/api/news/paths.js", "/api/news/latest": "pages/api/news/latest.js", "/api/videos": "pages/api/videos.js", "/api/wellness/topics": "pages/api/wellness/topics.js", "/api/search": "pages/api/search.js", "/conditions": "pages/conditions.html", "/dashboard": "pages/dashboard.js", "/doctors/[slug]": "pages/doctors/[slug].js", "/doctors": "pages/doctors.js", "/drugs-supplements": "pages/drugs-supplements.js", "/drugs": "pages/drugs.js", "/articles/[slug]": "pages/articles/[slug].js", "/editorial-board": "pages/editorial-board.js", "/ayurveda/[slug]": "pages/ayurveda/[slug].js", "/homeopathy": "pages/homeopathy.js", "/conditions/[slug]": "pages/conditions/[slug].js", "/homeopathy/[slug]": "pages/homeopathy/[slug].js", "/sitemap-images.xml": "pages/sitemap-images.xml.js", "/sitemap.xml": "pages/sitemap.xml.js", "/news/[slug]": "pages/news/[slug].js", "/drugs/[slug]": "pages/drugs/[slug].js", "/videos/[slug]": "pages/videos/[slug].js", "/well-being": "pages/well-being.js", "/": "pages/index.js", "/wellness/[slug]": "pages/wellness/[slug].js", "/yoga-exercise/[slug]": "pages/yoga-exercise/[slug].js" };
