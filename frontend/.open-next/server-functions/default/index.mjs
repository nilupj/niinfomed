...
var HtmlPages = ["/SharaButton", "/404", "/about-ads", "/about", "/account", "/account/saved", "/authors/[slug]", "/ayurveda", "/cms-status", "/content-test", "/contact", "/disclaimer", "/forgot-password", "/health-news", "/news", "/quizzes/[slug]", "/privacy", "/quizzes", "/remedies", "/remedies/slug", "/reviewers/[slug]", "/sentry-example-page", "/search", "/symptom-checker", "/tools", "/terms", "/trending/[slug]", "/trending", "/videos", "/wellness", "/yoga-exercise", "/conditions"];
