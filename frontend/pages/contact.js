  ...
  return (
    <Layout>
      <SEO 
        ...
        description="Have questions or feedback? Contact our team. We're here to help with your health information needs."
      />
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-neutral-600">info@healthinfo.com</p>
                        <p className="text-neutral-600">support@healthinfo.com</p>
                      </div>
                    </div>
